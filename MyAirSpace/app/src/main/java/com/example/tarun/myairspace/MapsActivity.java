...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        try {
            result = new JsonTask()
                            .execute("https://opensky-network.org/api/states/all").get();
        ...
        for (int i = 0; i < 2500; ++i) {
            ...
            if(str1[5].matches(".*\\d+.*") || str1[6].matches(".*\\d+.*") ) {
                LatLng latLng2 = new LatLng(Double.parseDouble(str1[6]), Double.parseDouble(str1[5]));
                mMap.addMarker(new MarkerOptions()
                        .position(latLng2)
                        .title("Flight "+str1[1])
                        .snippet("Origin: " + str1[2] +"\n" + "Latitude: "+ str1[6]+ "\n" + "Longitude: "+ str1[5] + "\n" + "Velocity: " + str1[9]+"m/s\n" + "Altitude: " + str1[7]+"m")
